...
public class AdminGoodsDAOImpl  implements AdminGoodsDAO{
	...
	@Override
	public List<ProductVO>selectNewGoodsList(Map condMap) throws DataAccessException {
		ArrayList<ProductVO>  goodsList=(ArrayList)sqlSession.selectList("mapper.admin.goods.selectNewGoodsList",condMap);
		return goodsList;
	}
	
	@Override
	public ProductVO selectGoodsDetail(int goods_id) throws DataAccessException{
		ProductVO goodsBean = new ProductVO();
		goodsBean=(ProductVO)sqlSession.selectOne("mapper.admin.goods.selectGoodsDetail",goods_id);
		return goodsBean;
	}
